  ...
  {:my-demo
   {;; :build contains parameters which are passed to the build
    :build {;; :watch-files contains a list of files to watch for
            ...
            ;; the templates.
            :triggers {:html [#"my_demo/rendering.js"]}}
    ...
    :aspects {;; Add an aspect that uses the data renderer
              ...
              :development {:uri "/my-demo-dev.html"
                            :name "Development"
                            :out-file "my-demo-dev.js"
                            :main 'my_demo.start
                            :logging? true
                            :order 3}
